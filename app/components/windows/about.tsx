    ...
    return (
        <div className="p-2 border border-black bg-white select-text">
            ...
            <p className="text-sm mt-2">
                I am from Russia originally, but last 10+ years I am travelling around the world for inspiration and other cultures exploring.
            </p>
            <p className="text-sm mt-2">
                Here, you can play around with some stuff I made just for fun.
            </p>
            <p className="text-sm mt-2">
